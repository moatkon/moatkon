...
template: splash
hero:
  tagline: Passion、AI、Self-hosted
  image:
   light: ../../assets/moatkon.svg
   dark: ../../assets/moatkon.svg
  actions:
    - text: 联系我
      link: https://links.moatkon.com
      icon: right-arrow
      variant: secondary
lastUpdated: 2026-08-23 12:47:13
---
...
<CardGrid>
	...
	<LinkCard
		...
		href="/homelab/deployment-architecture"
	/>
...
<CardGrid>
	<LinkCard
		title="X2Post 社区"
		description="认真分享 · 友善讨论"
		href="https://x2post.com"
	/>
